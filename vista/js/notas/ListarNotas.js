const ListarNotas = function($contenedor, _tpl8){
    var DT = null;
    ...
    this.obtenerNotas = async function(){
      const DOM = this.DOM;
    ...
    this.listarNotas = function(dataNotas){
      if (DT) {DT.fnDestroy(); DT = null;}
      this.DOM.tblLista.html(_tpl8.ListaNotas({admin : ___ad == 1 ? 1 : null, data: dataNotas}));
