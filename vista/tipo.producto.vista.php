...
$TITULO_PAGINA = "Gestión Tipo de Productos";
?>
...
<html leng="es">
    ...
    <body class="no-skin">
                              ...
                              <table class="table table-striped table-bordered table-hover dataTable dt-responsive"  cellspacing="0" width="100%">
                                  ...
                                  <tbody>
                                      {{#this}}
                                        <tr>
                                            <td>
                                                <button class="btn btn-xs btn-warning" onclick ="app.editar({{cod_tipo_producto}})" data-toggle="modal" data-target="#mdlRegistro">
                                                <i class="fa fa-edit bigger-130"></i>
                                                </button>
                                                <button class="btn btn-xs btn-danger" onclick ="app.eliminar({{cod_tipo_producto}})">
        ...
        <script src="js/tipo.producto.vista.js"></script>
    </body>
